...
public class fractal1 : MonoBehaviour {
    ...
    IEnumerator CreateChildren()
    {
        ...
        yield return new WaitForSeconds(0.5f);
       new GameObject("Fractal Child").AddComponent<fractal1>()
            .Initialize(this, Vector3.right, Quaternion.Euler(0f, 0f, -5f));
        yield return new WaitForSeconds(0.5f);
        new GameObject("Fractal Child").AddComponent<fractal1>()
            .Initialize(this, Vector3.left, Quaternion.Euler(0f, 0f, 5f));
    ...
    void Initialize(fractal1 parent, Vector3 direction, Quaternion orientation)
    {
        mesh = parent.mesh;
